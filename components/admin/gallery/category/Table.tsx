...
import GalleryCategoryStats from "./Stats";
import GalleryCategoryFilters from "./Filters";
import DeleteModal from "./modal/DeleteModal";

interface GalleryCategoryTableProps {
...
export default function GalleryCategoryTable({
  ...
  return (
    <div className="rounded-xl">
      <GalleryCategoryStats categories={filteredCategories} />
                  ...
                  >
                    ...
                    <td className="pl-4 pr-6 py-4 whitespace-nowrap">
                      <div className="flex items-center space-x-2">
                        <Link
                          href={`/admin/content/galleries/categories/edit/${category.id}`}
