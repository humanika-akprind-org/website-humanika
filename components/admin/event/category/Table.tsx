...
import EventCategoryStats from "./Stats";
import EventCategoryFilters from "./Filters";
...
export default function EventCategoryTable({
  ...
  return (
    <div className="rounded-xl">
      <EventCategoryStats categories={filteredCategories} />
                  ...
                  >
                    ...
                    <td className="pl-4 pr-6 py-4 whitespace-nowrap">
                      <div className="flex items-center space-x-2">
                        <Link
                          href={`/admin/program/events/categories/edit/${category.id}`}
