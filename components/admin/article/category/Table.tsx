...
import ArticleCategoryStats from "./Stats";
import ArticleCategoryFilters from "./Filters";
...
export default function ArticleCategoryTable({
    ...
    return (
      <div className="bg-white rounded-lg shadow-sm border border-gray-100 p-8 text-center">
        ...
        <p className="text-gray-500">
          Get started by creating your first article category.
        </p>
      </div>
    );
  }
  ...
  return (
    <div className="rounded-xl">
      <ArticleCategoryStats categories={filteredCategories} />
        ...
        {selectedCategories.length > 0 && (
          <div className="flex items-center gap-2">
            <span className="text-sm text-gray-600">
              ...
              {selectedCategories.length > 1 ? "ies" : ""} selected
            </span>
          </div>
        )}
      </div>
                  ...
                  <tr key={category.id} className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="pl-4 pr-6 py-4 whitespace-nowrap">
                      <div className="flex items-center space-x-2">
                        <Link
                          href={`/admin/content/articles/categories/edit/${category.id}`}
                        ...
                        <button
                          ...
                          disabled={!!(category._count?.articles && category._count.articles > 0)}
                        >
                          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
