          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                required
                className="bg-gray-700 text-white placeholder-gray-400 w-full px-4 py-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent pr-10"
