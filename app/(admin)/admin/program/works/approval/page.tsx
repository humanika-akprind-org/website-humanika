...
export default function WorkProgramApprovalPage() {
  ...
  const clearFilters = () => {
    setFilters({ status: "", entityType: "WORK_PROGRAM" });
    setSearchTerm("");
    setCurrentPage(1);
  };
      ...
      <div className="bg-white p-4 rounded-xl shadow-sm mb-6 border border-gray-100">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-4">
          <div className="relative flex-1">
            ...
            <input
              type="text"
              placeholder="Search by user name, email, or work program name..."
              value={searchTerm}
        ...
        {loading ? (
          <div className="p-8 text-center">
            ...
            <p className="mt-2 text-gray-600">
              Loading work program approvals...
            </p>
          </div>
          ...
          <div className="p-8 text-center">
            ...
            <p className="text-gray-500 text-lg font-medium">
              No work program approvals found
            </p>
            <p className="text-gray-400 mt-1">
              {searchTerm || filters.status
                ? "Try adjusting your search or filter criteria"
                : "No work program approval requests at the moment"}
            </p>
          </div>
        ) : (
          <>
