...
export default function FinanceApprovalPage() {
  ...
  const [filters, setFilters] = useState({
    status: "",
    entityType: "FINANCE", // Fixed to finance only
  });
  ...
  const handleApprove = async (approvalId: string) => {
    try {
      ...
      if (response.error) {
        ...
        setSuccess("Finance approval updated successfully");
        fetchApprovals();
  ...
  const clearFilters = () => {
    setFilters({ status: "", entityType: "FINANCE" });
    setSearchTerm("");
    setCurrentPage(1);
  };
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6">
        <div>
          ...
          <p className="text-gray-600 mt-1">
            Review and manage finance transaction approval requests
          </p>
        </div>
      </div>
      ...
      <div className="bg-white p-4 rounded-xl shadow-sm mb-6 border border-gray-100">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-4">
          <div className="relative flex-1">
            ...
            <input
              type="text"
              placeholder="Search by user name, email, or transaction name..."
              value={searchTerm}
      ...
      <div className="bg-white rounded-xl shadow-sm overflow-hidden border border-gray-100">
        {loading ? (
          <div className="p-8 text-center">
            ...
            <p className="mt-2 text-gray-600">Loading finance approvals...</p>
          </div>
          ...
          <div className="p-8 text-center">
            ...
            <p className="text-gray-400 mt-1">
              {searchTerm || filters.status
                ...
                : "No finance approval requests at the moment"}
            </p>
          </div>
        ) : (
          <>
                ...
                {filteredApprovals.map((approval) => (
                  <tr key={approval.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      ...
                      >
                        {approval.finance?.amount
                          ? formatCurrency(approval.finance.amount)
                          : "N/A"}
                      </div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
