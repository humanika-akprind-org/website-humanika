export default function QuickActions() {
  const actions = [
    { name: "Upload File", icon: "upload", color: "bg-blue-100 text-blue-600" },
    {
      name: "Create Folder",
      icon: "folder-add",
      color: "bg-green-100 text-green-600",
    },
    { name: "Share", icon: "share", color: "bg-purple-100 text-purple-600" },
    { name: "Settings", icon: "cog", color: "bg-gray-100 text-gray-600" },
  ];
